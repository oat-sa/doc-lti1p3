...
You can use the [EndAssessmentLaunchRequestBuilder](https://github.com/oat-sa/lib-lti1p3-proctoring/blob/master/src//Message/Launch/Builder/EndAssessmentLaunchRequestBuilder.php) to create the message:
