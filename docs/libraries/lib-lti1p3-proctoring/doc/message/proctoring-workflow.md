...
You can use the [StartProctoringLaunchRequestBuilder](https://github.com/oat-sa/lib-lti1p3-proctoring/blob/master/src//Message/Launch/Builder/StartProctoringLaunchRequestBuilder.php) to create the message:
...
As a result of the build, you get a [LtiMessageInterface](https://github.com/oat-sa/lib-lti1p3-proctoring/blob/master/src//Message/LtiMessageInterface.php) instance that has to be used in the following ways:
...
Once the proctor's candidate attempt validation is done, you can return to the platform using a [StartAssessment message](https://www.imsglobal.org/spec/proctoring/v1p0#h.a81u3sn00k84), by using the [StartAssessmentLaunchRequestBuilder](https://github.com/oat-sa/lib-lti1p3-proctoring/blob/master/src//Message/Launch/Builder/StartAssessmentLaunchRequestBuilder.php):
...
As a result of the build, you get a [LtiMessageInterface](https://github.com/oat-sa/lib-lti1p3-proctoring/blob/master/src//Message/LtiMessageInterface.php) instance that has to be sent as a form POST:
